...
export default {
    ...
    settingsTreeDisplayDescription: 'Contrôle les suggestions de schéma et le placement des alias dans l\'arborescence.',
    ...
    settingsSchemaConfigurationHeader: 'Configuration des règles',
    settingsSchemaConfigurationDescription: 'Configure comment les fichiers de règles sont détectés et utilisés',
    settingsDendronConfigFilePath: 'Chemin du fichier de configuration des règles',
    settingsDendronConfigFilePathDesc: 'Chemin vers le fichier de configuration des règles (par défaut : dot-navigator-rules.json)',
    settingsDendronConfigPathValid: 'Fichier de configuration trouvé',
    settingsDendronConfigPathInvalid: 'Fichier de configuration introuvable',
    settingsOpenDendronConfigFile: 'Ouvrir le fichier',
    settingsOpenDendronConfigFileDesc: 'Ouvrir le fichier de configuration des règles',
    settingsCreateDendronConfigFile: 'Créer le fichier',
    settingsCreateDendronConfigFileDesc: 'Créer le fichier de configuration des règles',
