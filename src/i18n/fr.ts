...
export default {
    ...
    settingsSchemaConfigurationHeader: 'Configuration du schéma',
    settingsSchemaConfigurationDescription: 'Configure comment les fichiers de schéma sont détectés et utilisés',
    settingsDendronConfigFilePath: 'Chemin du fichier de configuration Dendron',
    settingsDendronConfigFilePathDesc: 'Chemin vers le fichier de configuration dendron (par défaut : dendron.yaml)',
    ...
    settingsOpenDendronConfigFileDesc: 'Ouvrir le fichier de configuration dendron',
    settingsCreateDendronConfigFile: 'Créer le fichier',
    settingsCreateDendronConfigFileDesc: 'Créer le fichier de configuration dendron',
