...
export default {
    ...
    settingsDendronConfigPreview: 'Aperçu du fichier de configuration',
    settingsDendronConfigPreviewDesc: 'Aperçu du fichier de configuration dendron actuel',
    settingsCreateDendronConfigFile: 'Créer le fichier de configuration',
    settingsCreateDendronConfigFileDesc: 'Créer le fichier de configuration dendron s\'il n\'existe pas',
    settingsDendronConfigFileNotFound: 'Fichier de configuration non trouvé',
    settingsDendronConfigFileContent: 'Contenu :',
