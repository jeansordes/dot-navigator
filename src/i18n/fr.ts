...
export default {
    ...
    commandCreateShortcut: 'Créer un raccourci vers cette note…',
    ...
    tooltipCreateFolder: 'Créer un dossier : {{path}}',
    ...
    menuRename: 'Renommer',
    menuCreateNote: 'Créer une note',
    menuCreateFolder: 'Créer un dossier',
    shortcutDestinationPlaceholder: 'Choisir l’emplacement du raccourci…',
    shortcutDestinationRoot: 'Racine du coffre',
    shortcutDestinationFolder: 'Dossier',
    shortcutDestinationNote: 'Note',
    ...
    noticeFailedCreateFolder: 'Échec de création du dossier : {{error}}',
    ...
    settingsEnableSchemaSuggestionsDesc: 'Affiche les fichiers et dossiers virtuels suggérés par les règles',
    ...
    settingsHideDotPaths: 'Traiter les chemins commençant par un point comme cachés',
    settingsHideDotPathsDesc: 'Marque par défaut comme cachés les chemins dont le nom commence par un point (ex. .git, dossiers de paramètres des plugins, .gitignore).',
    settingsRevealDotFilesystem: 'Autoriser le bouton œil à afficher les chemins point/système',
    settingsRevealDotFilesystemDesc: 'Lorsque le bouton œil est actif, affiche aussi les dossiers sensibles commençant par un point comme le dossier de configuration de l\'application, .git et les répertoires de paramètres des plugins.',
    ...
    settingsSchemaConfigurationDescription: 'Définissez des règles qui suggèrent des notes et dossiers enfants dans l\'arborescence.',
    settingsRulesHeader: 'Règles de suggestion',
    settingsRulesEmpty: 'Aucune règle de suggestion',
    settingsRulesEmptyDesc: 'Ajoutez une règle ou importez du JSON pour commencer à suggérer des notes et dossiers enfants.',
    ...
    settingsRulesErrorInvalidChildPath: 'Chemin enfant invalide : {{path}}',
    settingsRulesPreviewToggle: 'Aperçu des correspondances',
    settingsRulesMatchCount: '{{count}} correspondances',
    settingsRulesPreviewMatches: 'Notes et dossiers correspondants ({{count}})',
    settingsRulesPreviewNoMatches: 'Aucune note ni aucun dossier ne correspond à cette règle',
    ...
    settingsBuiltinCreateFolder: 'Créer un dossier',
    settingsBuiltinCreateShortcut: 'Créer un raccourci',
    settingsBuiltinCopyPath: 'Copier le chemin',
    ...
    settingsTipCreateShortcutTitle: 'Créer un raccourci de note',
    settingsTipCreateShortcutDescription: 'Dans le menu Plus d’une note, choisissez « Créer un raccourci vers cette note… », puis sélectionnez une destination. La commande du même nom peut recevoir un raccourci clavier dans les réglages des raccourcis d’Obsidian. Vous pouvez aussi maintenir Maj pendant un glisser-déposer.',
