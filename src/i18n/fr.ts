...
export default {
    ...
    settingsRulesImportExport: 'Importer / exporter JSON',
    settingsRulesImportExportTitle: 'Importer ou exporter les règles JSON',
    settingsRulesImportExportDesc: 'Collez un tableau JSON de règles. Les champs inconnus sont conservés à l\'import.',
    ...
    settingsRulesImported: 'Règles importées',
    ...
    settingsMoreMenuDescription: 'Personnalisez le menu trois-points. Les éléments intégrés ne peuvent pas être supprimés, mais vous pouvez les réorganiser en glissant la poignée ou avec les flèches.',
