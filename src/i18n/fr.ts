...
export default {
    ...
    settingsTreeDisplayDescription: 'Contrôle le placement des alias et l\'affichage du nombre d\'enfants dans l\'arborescence.',
    settingsAliasVirtualMode: 'Nœuds virtuels via alias',
    settingsAliasVirtualModeDesc: 'Utilise les alias YAML pour placer les notes à d\'autres emplacements dans l\'arborescence. « Alias avec points » ignore les libellés simples (ex. titres de journal).',
    settingsAliasVirtualModeDotted: 'Alias avec points uniquement',
    settingsAliasVirtualModeAll: 'Tous les alias',
    settingsAliasVirtualModeOff: 'Désactivé',
    ...
    settingsHiddenNodesDescription: 'Gérez les fichiers et dossiers masqués dans l\'arborescence.',
