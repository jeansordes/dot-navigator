...
export default {
    ...
    settingsHiddenNodesDescription: 'Gérez les fichiers et dossiers masqués dans l\'arborescence, y compris les éléments du système de fichiers commençant par un point (ex. .git, .gitignore), masqués par défaut.',
    settingsShowHiddenNodes: 'Afficher les nœuds cachés',
    settingsShowHiddenNodesDesc: 'Lorsque cette option est activée, les fichiers et dossiers masqués apparaissent estompés dans l\'arborescence avec une icône en forme d\'œil',
    settingsHideDotPaths: 'Masquer les fichiers et dossiers commençant par un point',
    settingsHideDotPathsDesc: 'Masque les chemins dont le nom commence par un point (ex. .git, .obsidian, .gitignore). Utilisez le bouton œil de l\'en-tête ou l\'option ci-dessus pour les afficher.',
    ...
    noticeCannotOpenDotFile: 'Ce fichier n\'est pas géré par Obsidian. Utilisez Afficher dans l\'explorateur système sur ordinateur.',
