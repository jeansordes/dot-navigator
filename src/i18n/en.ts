...
export default {
    ...
    settingsHideDotPaths: 'Hide dot-prefixed files and folders',
    settingsHideDotPathsDesc: 'Hide paths whose name starts with a dot (e.g. .git, .obsidian, .gitignore). They stay hidden unless you also enable both options below.',
    settingsRevealDotFilesystem: 'Include dot/system folders when revealing hidden',
    settingsRevealDotFilesystemDesc: 'Secondary opt-in: when the eye toggle is on, also reveal dot-prefixed folders such as .obsidian, .git, and plugin configuration directories.',
