...
export default {
    ...
    settingsSchemaConfigurationHeader: 'Schema Configuration',
    settingsSchemaConfigurationDescription: 'Configure how schema files are detected and used',
    settingsDendronConfigFilePath: 'Dendron config file path',
    settingsDendronConfigFilePathDesc: 'Path to the dendron configuration file (default: .dendron.yaml)',
    settingsDendronConfigPreview: 'Config file preview',
    settingsDendronConfigPreviewDesc: 'Preview of the current dendron configuration file',
    settingsCreateDendronConfigFile: 'Create config file',
    settingsCreateDendronConfigFileDesc: 'Create the dendron configuration file if it doesn\'t exist',
    settingsDendronConfigFileNotFound: 'Config file not found',
    settingsDendronConfigFileContent: 'Content:',
