...
export default {
    ...
    settingsSchemaConfigurationDescription: 'Define rules that suggest virtual child notes in the tree.',
    settingsRulesHeader: 'Suggestion rules',
    settingsRulesEmpty: 'No suggestion rules yet',
    settingsRulesEmptyDesc: 'Add a rule or import JSON to start suggesting virtual child notes.',
