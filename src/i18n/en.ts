...
export default {
    ...
    commandCreateShortcut: 'Create shortcut to this note…',
    ...
    tooltipCreateFolder: 'Create folder: {{path}}',
    tooltipCreateChildNote: 'Create child note: {{path}}',
    tooltipMoreActions: 'More actions',
    tooltipChildCount: '{{count}} direct children',
    tooltipChildCountBoth: '{{direct}} direct · {{total}} total',
    tooltipChildCountBadgeBoth: '{{direct}} · {{total}} total',
    tooltipChildCountSame: '{{count}} children',
    tooltipChildCountEmpty: 'No children — create a note here',
    menuRename: 'Rename',
    menuCreateNote: 'Create note',
    menuCreateFolder: 'Create folder',
    shortcutDestinationPlaceholder: 'Choose shortcut location…',
    shortcutDestinationRoot: 'Vault root',
    shortcutDestinationFolder: 'Folder',
    ...
    noticeFailedCreateFolder: 'Failed to create folder: {{error}}',
    ...
    noticeNothingToMove: 'Nothing to move for: {{path}}',
    ...
    settingsEnableSchemaSuggestionsDesc: 'Display virtual file and folder suggestions defined by rules',
    settingsTreeDisplayHeader: 'Tree display',
    settingsTreeDisplayDescription: 'Control child count badges in the tree.',
    settingsChildCountDisplay: 'Child count',
    settingsChildCountDisplayDesc: 'Show child count badges on tree rows (direct children, always visible when enabled)',
    settingsChildCountMode: 'Count type',
    settingsChildCountModeDesc: 'Choose whether the badge shows direct children, total descendants, or both',
    ...
    settingsEnableHiddenNodesRevealDesc: 'Shows the eye toggle in the panel header so you can temporarily reveal files and folders you hid manually or via patterns.',
    settingsHideDotPaths: 'Treat dot-prefixed paths as hidden',
    settingsHideDotPathsDesc: 'Marks paths whose name starts with a dot as hidden by default (e.g. .git, plugin settings folders, .gitignore).',
    settingsRevealDotFilesystem: 'Allow the eye toggle to reveal dot/system paths',
    settingsRevealDotFilesystemDesc: 'When the eye toggle is on, also reveal sensitive dot-prefixed folders such as the app configuration folder, .git, and plugin settings directories.',
    settingsRevealDotFilesystemWarning: 'These folders contain app and plugin settings. Only enable this if you know what you are doing.',
    settingsHiddenPatterns: 'Hide patterns',
    settingsHiddenPatternsDesc: 'Glob patterns for additional hidden paths. Use * for one segment and ** for multiple (e.g. archive/**). Press Enter to add.',
    settingsHiddenPatternsPlaceholder: 'e.g. archive/**',
    settingsAddHiddenPattern: 'Add pattern',
    settingsNoHiddenPatterns: 'No hide patterns',
    settingsNoHiddenNodes: 'No hidden nodes',
    noticeCannotOpenDotFile: 'This file cannot be opened on mobile. On desktop, click it to open in your default app.',
    ...
    settingsSchemaConfigurationDescription: 'Define rules that suggest child notes and folders in the tree.',
    settingsRulesHeader: 'Suggestion rules',
    settingsRulesEmpty: 'No suggestion rules yet',
    settingsRulesEmptyDesc: 'Add a rule or import JSON to start suggesting child notes and folders.',
    settingsRulesAddRule: 'Add rule',
    settingsRulesViewJson: 'View JSON',
    settingsRulesImportJsonButton: 'Import JSON',
    settingsRulesExportTitle: 'Rules JSON',
    settingsRulesExportDesc: 'Your current rules as JSON. Copy this to back up or share your configuration.',
    settingsRulesImportTitle: 'Import rules JSON',
    settingsRulesImportDesc: 'Paste a JSON array of rules to add them to your current rules. Unknown fields are preserved on import.',
    settingsClose: 'Close',
    settingsRulesCopyJson: 'Copy JSON',
    settingsRulesImportJson: 'Import',
    settingsRulesCopiedJson: 'Rules JSON copied to clipboard',
    settingsRulesCopyFailed: 'Failed to copy JSON',
    settingsRulesInvalidJson: 'Invalid JSON',
    settingsRulesMustBeArray: 'Rules must be a JSON array',
    settingsRulesNoValidRules: 'No valid rules found in JSON',
    settingsRulesImported: 'Imported rules added',
    settingsRulesReloaded: 'Suggestion rules reloaded',
    settingsRulesReloadFailed: 'Failed to reload rules',
    settingsRulesCardTitle: 'Rule {{index}}',
    settingsRulesPatternLabel: 'Pattern (one per line)',
    settingsRulesExcludeLabel: 'Exclude (one per line, optional)',
    settingsRulesChildrenLabel: 'Children (one per line)',
    ...
    settingsRulesErrorInvalidChildPath: 'Invalid child path: {{path}}',
    settingsRulesPreviewToggle: 'Preview matches',
    settingsRulesMatchCount: '{{count}} matches',
    settingsRulesPreviewMatches: 'Matched notes and folders ({{count}})',
    settingsRulesPreviewNoMatches: 'No note or folder matches this rule',
    settingsRulesPreviewTruncated: '…and {{count}} more',
    settingsRulesPreviewChildren: 'Suggested children: {{children}}',
    settingsMoreMenuHeader: 'More Menu',
    settingsMoreMenuDescription: 'Customize the three-dots menu. Built-in items cannot be removed, but you can reorder them. Add your own custom commands and drag, reorder, edit, or remove them at any time.',
    settingsBuiltinItems: 'Built-in items',
    settingsBuiltinChip: 'Built-in',
    settingsCustomCommands: 'Custom commands',
    settingsCustomChip: 'Custom',
    ...
    settingsBuiltinCreateFolder: 'Create folder',
    settingsBuiltinCreateShortcut: 'Create shortcut',
    settingsBuiltinCopyPath: 'Copy path',
    ...
    settingsTipCreateShortcutTitle: 'Create a note shortcut',
    settingsTipCreateShortcutDescription: 'From a note’s More menu, choose “Create shortcut to this note…” and select a destination. The command with the same name can receive a hotkey in Obsidian’s Hotkeys settings. You can also hold Shift while dragging a note.',
