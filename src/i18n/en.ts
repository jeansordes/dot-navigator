...
export default {
    ...
    settingsHiddenNodesDescription: 'Manage files and folders hidden from the tree, including dot-prefixed filesystem items (e.g. .git, .gitignore) which are hidden by default.',
    ...
    settingsHideDotPathsDesc: 'Hide paths whose name starts with a dot (e.g. .git, .obsidian, .gitignore). Use the header eye toggle or this setting\'s companion toggle above to reveal them.',
    ...
    noticeCannotOpenDotFile: 'This file is not managed by Obsidian. Use Show in system explorer on desktop.',
