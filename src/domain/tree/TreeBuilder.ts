/**
 * Pure domain logic for building tree structures.
 * This version works with plain data types and has no external dependencies.
 */
...
export class TreeBuilder {
  ...
  /**
   * Build the tree structure from files and folders
   */
  public buildDendronStructure(folders: FolderInfo[], files: FileInfo[]): TreeNode {
  ...
  /**
   * Build the paths by depth level map
   */
  public buildPathsByDepthLevel(files: FileInfo[], folders: FolderInfo[]): Map<number, Set<string>> {
  ...
  /**
   * Get the number of children for a path
   */
